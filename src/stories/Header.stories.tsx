    ...
    decorators: [
        (Story, { args }) => (
            <PlatformContext.Provider value={args.platformContextValue}>
                <div style={{padding: "100px", background: "#eee", width: args.platformContextValue === 'desktop' ? "1000px" : "400px"}} >
                    <Story />
                </div>
...
} satisfies Meta< ComponentProps<typeof Header> & { platformContextValue: Platform }>;
